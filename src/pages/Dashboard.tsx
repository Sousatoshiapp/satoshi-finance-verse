        ...
        <div className={`mx-auto ${isMobile ? 'max-w-sm' : 'max-w-md'}`}>
          ...
          */}
          ...
          <div className={`${isMobile ? 'mb-6' : 'mb-8'} text-center relative`}>
            ...
            >
              <div className="flex flex-col items-center gap-1 text-foreground group-hover:text-primary-foreground">
                <svg className="w-24 h-24 group-hover:animate-pulse text-foreground group-hover:text-primary-foreground" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M7 6v12l10-6z"/>
                </svg>
                <span className="text-xs text-foreground group-hover:text-primary-foreground">{t('common.play')}</span>
              </div>
            </Button>
