...
const topics = [
  { id: "financas", name: "Finanças", emoji: "💰", color: "bg-green-500/10 text-green-700 border-green-300" },
  { id: "cripto", name: "Criptomoedas", emoji: "₿", color: "bg-orange-500/10 text-orange-700 border-orange-300" },
  { id: "investimentos", name: "Investimentos", emoji: "📈", color: "bg-blue-500/10 text-blue-700 border-blue-300" },
  { id: "economia", name: "Economia", emoji: "🏦", color: "bg-purple-500/10 text-purple-700 border-purple-300" }
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-6 space-y-6">
        ...
        <Card className="border-border/30 bg-background/50">
          ...
          <CardContent>
            <Label className="text-sm font-medium">Escolha o tópico do duelo</Label>
        ...
        <Tabs defaultValue="quick" className="w-full">
          <TabsList className="grid w-full grid-cols-3 h-10">
            <TabsTrigger value="quick" className="text-sm">Partida Rápida</TabsTrigger>
            ...
            <Card className="border-border/30 bg-background/50">
              ...
              <CardContent>
                <div className="text-center py-8">
                  ...
                  <p className="text-sm text-muted-foreground">Adicione amigos para desafiá-los</p>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
