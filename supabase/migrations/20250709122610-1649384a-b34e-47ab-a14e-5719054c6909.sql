-- ===================================================================
-- FASE 1: ESTRUTURA EDUCACIONAL CONSOLIDADA (CORRIGIDA)
-- ===================================================================
...
-- 5. Melhorar tabela de progresso do usuário (SRS) - CORRIGIDO para user_question_progress
...
BEGIN
    ...
    -- Atualizar user_question_progress existente
