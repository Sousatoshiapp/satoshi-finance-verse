-- CORREÇÃO DEFINITIVA DAS POLÍTICAS RLS PROBLEMÁTICAS - VERSÃO 3
-- Remove políticas que expõem dados sensíveis e implementa políticas restritivas

-- ========================================
-- FASE 1: REMOVER VIEWS EXISTENTES PRIMEIRO
-- ========================================
...
-- ========================================
-- FASE 2: REMOVER TODAS AS POLÍTICAS PROBLEMÁTICAS
-- ========================================
...
-- ========================================
-- FASE 3: IMPLEMENTAR POLÍTICAS RESTRITIVAS LIMPAS
-- ========================================
...
-- ========================================
-- FASE 4: CRIAR VIEWS SEGURAS PARA FUNCIONALIDADE PÚBLICA
-- ========================================

-- View segura para leaderboard
...
-- View segura para atividades públicas (sem dados sensíveis)
...
SELECT 
  ...
  p.nickname,
  CASE 
    WHEN af.activity_type IN ('quiz_completed', 'level_up', 'mission_completed') 
    THEN af.activity_data
    ELSE '{}'::jsonb
  END as safe_activity_data
FROM public.activity_feed af
JOIN public.profiles p ON af.user_id = p.id
WHERE af.activity_type IN ('quiz_completed', 'level_up', 'mission_completed', 'achievement_unlocked')
