...
-- Fase 3: Policies RESTRITIVAS nas tabelas principais

-- PROFILES: Apenas usuário dono pode ver dados completos
...
-- Fase 4: Garantir que tabelas sensíveis tenham RLS ativo
...
-- Fase 5: Função helper para leaderboard (sem exposição de dados sensíveis)
