...
-- Remover todas as policies que expõem dados sensíveis
DROP POLICY IF EXISTS "Profiles are viewable by everyone" ON public.profiles;
DROP POLICY IF EXISTS "Portfolio items are viewable by followers" ON public.portfolio_items;
...
-- PORTFOLIO_ITEMS: Apenas usuário dono pode ver dados completos
CREATE POLICY "Users can view their own portfolio items only" 
