...
-- Atualizar handle_new_user function
...
AS $$
DECLARE
  starter_avatar_id UUID;
BEGIN
  -- Buscar um avatar starter disponível
  SELECT id INTO starter_avatar_id
  FROM avatars 
  WHERE is_starter = true 
  AND is_available = true
  LIMIT 1;
  
  -- Inserir perfil com dados do metadata do usuário
...
-- 5. APLICAR SEARCH_PATH A MAIS FUNÇÕES CRÍTICAS
-- Update function search paths para segurança
